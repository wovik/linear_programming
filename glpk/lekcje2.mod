...
s.t. hpref{l in Lekcje}: sum{i in 1..4: pref[l,i] < 5} choice[l,i] = 0;

/* Tylko dni */
s.t. noSr: sum{l in Lekcje, i in 1..4: days[l,i] = 3} choice[l,i] = 0;
s.t. noPt: sum{l in Lekcje, i in 1..4: days[l,i] = 5} choice[l,i] = 0;
